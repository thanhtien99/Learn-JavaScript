var sub = 0;
var product;
// Show món ăn(dữ liệu) đã chọn dưới dạng table
function show() {
  sub = 0;
  ...
  // nhập và thay đôi số lương
    var newQty =
      "<input type='number' value='" + qty + "' id='nm_" + i + "' onkeyup='calculate(" + i + "); total()'>";
    var newResult =
...
// lưu món ăn đã chọn vào Local và sang trang thanh toán
